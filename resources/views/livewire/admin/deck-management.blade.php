<div class="p-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-white">Deck Management</h1>
                            ...
                            @if($deck->categories && $deck->categories->isNotEmpty())
                                <div class="flex flex-wrap gap-1">
                                    @foreach($deck->categories as $category)
                                        <span class="inline-flex items-center px-2 py-1 bg-burgundy-900/30 text-burgundy-300 rounded text-xs">
                                            {{ $category->name }}
                                        </span>
                                    @endforeach
                                </div>
                            ...
                            @else
                                <div class="flex items-center gap-2">
                                    ...
                                    <a href="{{ route('admin.decks.materials', $deck->id) }}" 
                                       class="inline-flex items-center px-3 py-1 bg-gray-700 text-green-400 rounded-lg hover:bg-gray-600 transition text-sm font-medium"
